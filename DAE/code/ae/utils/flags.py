...
flags.DEFINE_integer('chunk_length', 15, 'Length of the chunks, in which we will be processing our data. Define the length of the memory for RNN.')
...
flags.DEFINE_integer('chkpt_num' , 52500, 'Number of the checkpoint')
...
flags.DEFINE_float('delta_for_early_stopping', 1, 'How much worst the results must get in order for training to be terminated. 0.05 mean 5% worst than best we had')
...
flags.DEFINE_string('data_dir','/home/taras/Documents/Datasets/MoCap/BVH/Raw',
 			#'/home/taras/Documents/storage/CMU_Mocap/BVH/24k_30L',
