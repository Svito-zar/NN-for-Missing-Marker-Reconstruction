...
_ALLOCATIONTYPE = _descriptor.EnumDescriptor(
  name='AllocationType',
  full_name='tensorflow.AllocationType',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      name='AT_NOTUSED', index=0, number=0,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='AT_ALLOCATED', index=1, number=1,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='AT_EXISTING', index=2, number=2,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='AT_REF', index=3, number=3,
      options=None,
      type=None),
  ],
...
_NODEOUTPUT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='allocation_type', full_name='tensorflow.NodeOutput.allocation_type', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tensor_description', full_name='tensorflow.NodeOutput.tensor_description', index=2,
...
_NODEOUTPUT.fields_by_name['allocation_type'].enum_type = _ALLOCATIONTYPE
